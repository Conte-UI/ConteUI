...
Helix UI provides a fully dynamic coloring system with support for both raw CSS values and Material Design colors.
...
<div class="text-color:hsla(200,50%,50%,0.5)">HelixUI</div>
...
Helix UI supports Material Design color tokens for quick and consistent theming.
...
* Helix generates a full Material color system dynamically
