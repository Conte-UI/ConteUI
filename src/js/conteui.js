        ...
        if (Configured[property]) {
            ...
            ["ltr", "rtl"].forEach(dir => {
                ...
                let { properties, valueCount, fluid, axis, strategy } =
                    preConfigMap;
                if (Config.mode === "isStatic")
                    fluid = result.hasFluid[i] ? true : false;
                if (Config.mode === "isFluid")
