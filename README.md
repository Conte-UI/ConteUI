...
```html
<script src="https://cdn.jsdelivr.net/gh/Conte-UI/ConteUI@main/dist/bundle/conteui-v0.1.2-beta.min.js" integrity="sha384-Mdg+FBm38Z5vuynRhXThHRHOX/B/RhIQQRBAq4WEPlex3p3CXVhtM1VsTnhgw1xq" crossorigin="anonymous"></script>
```
